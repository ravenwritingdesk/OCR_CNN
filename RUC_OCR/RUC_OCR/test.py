...
def initDir(name):
    ...
    global charDir
    global downloadDir
    uploadDir = os.path.join(baseDir, 'Upload_DownloadFile', name)
    os.mkdir(uploadDir)
    saveDir = os.path.join(baseDir,'UntreatedImage', name)
    os.mkdir(saveDir)
    splitDir = os.path.join(baseDir,'SplitImage', name)
    os.mkdir(splitDir)
    charDir = os.path.join(baseDir, 'SplitChar', name)
    os.mkdir(charDir)
    downloadDir = os.path.join(baseDir, 'Upload_DownloadFile', name + 'Download')
